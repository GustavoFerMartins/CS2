                    ...
                    <div className="box">
                        <div className="flex items-center">
                            <div className="relative flex items-center">
                                <img
                                    src="https://img-cdn.hltv.org/playerbodyshot/sAqrpGeO7o3rl7yNYfTMdQ.png?bg=3e4c54&h=200&ixlib=java-2.1.0&rect=109%2C0%2C494%2C494&w=200&s=5fc15518c37a63f075f05b3dd0bdc6a0"
                                    alt="Foto"
                                    className="player-photo"
                                />
                                <img
                                    src="https://img-cdn.hltv.org/teamlogo/ywdn4tmAvXfllLeV2SkkvF.png?ixlib=java-2.1.0&w=200&s=4878ec4edb411cf0c348226b0798d14f"
                                    alt="Foto"
                                    className="team-foto"
                                />
                            </div>
